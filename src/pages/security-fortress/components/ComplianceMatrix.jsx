...
const ComplianceMatrix = () => {
  ...
  const complianceStandards = [
    ...
    },
    {
      id: 2,
      name: "HIPAA",
      description: "Ley de Portabilidad y Responsabilidad del Seguro Médico",
      status: "Compliant",
      compliance: 98,
      lastAudit: "20/07/2024",
      nextAudit: "20/01/2025",
      icon: "Heart",
      color: "primary",
      requirements: [
        {
          category: "Salvaguardas Administrativas",
          items: [
            { name: "Oficial de Seguridad Designado", status: "Completo", progress: 100 },
            { name: "Capacitación del Personal", status: "Completo", progress: 100 },
            { name: "Plan de Contingencia", status: "Completo", progress: 100 }
          ]
        },
        {
          category: "Salvaguardas Físicas",
          items: [
            { name: "Control de Acceso a Instalaciones", status: "Completo", progress: 100 },
            { name: "Control de Estaciones de Trabajo", status: "Completo", progress: 100 },
            { name: "Control de Medios y Dispositivos", status: "En Progreso", progress: 95 }
          ]
        },
        {
          category: "Salvaguardas Técnicas",
          items: [
            { name: "Control de Acceso", status: "Completo", progress: 100 },
            { name: "Registro de Auditoría", status: "Completo", progress: 100 },
            { name: "Integridad", status: "Completo", progress: 100 }
          ]
        }
      ]
    },
    {
      ...
      nextAudit: "10/01/2025",
      icon: "Globe",
      color: "secondary",
      requirements: [
        {
          category: "Derechos del Interesado",
          items: [
            { name: "Derecho de Acceso", status: "Completo", progress: 100 },
            { name: "Derecho de Rectificación", status: "Completo", progress: 100 },
            { name: "Derecho al Olvido", status: "En Progreso", progress: 90 }
          ]
        },
        {
          category: "Protección de Datos por Diseño",
          items: [
            { name: "Minimización de Datos", status: "Completo", progress: 100 },
            { name: "Pseudonimización", status: "Completo", progress: 100 },
            { name: "Cifrado", status: "Completo", progress: 100 }
          ]
        },
        {
          category: "Responsabilidad Proactiva",
          items: [
            { name: "Evaluación de Impacto", status: "Completo", progress: 100 },
            { name: "Registro de Actividades", status: "En Progreso", progress: 95 },
            { name: "Notificación de Brechas", status: "Completo", progress: 100 }
          ]
        }
      ]
    },
    {
      ...
      status: "Certificado",
      compliance: 99,
      lastAudit: "01/08/2024",
      nextAudit: "01/08/2025",
      icon: "Building",
      color: "accent",
      requirements: [
        {
          category: "Seguridad",
          items: [
            { name: "Controles de Acceso Lógico", status: "Completo", progress: 100 },
            { name: "Detección de Intrusiones", status: "Completo", progress: 100 },
            { name: "Gestión de Vulnerabilidades", status: "Completo", progress: 100 }
          ]
        },
        {
          category: "Disponibilidad",
          items: [
            { name: "Monitoreo de Sistemas", status: "Completo", progress: 100 },
            { name: "Gestión de Incidentes", status: "Completo", progress: 100 },
            { name: "Planificación de Capacidad", status: "En Progreso", progress: 98 }
          ]
        },
        {
          category: "Confidencialidad",
          items: [
            { name: "Clasificación de Datos", status: "Completo", progress: 100 },
            { name: "Cifrado de Datos", status: "Completo", progress: 100 },
            { name: "Gestión de Claves", status: "Completo", progress: 100 }
          ]
        }
      ]
    }
